...
fp_data = '/Users/norelis/Documents/MATLAB/FI_DATA/';
...
experiment = { 'EVN_22junthrough30jun','DRP_22junthrough30jun'};
...
color1 = fun([0 255 0],tint_factor(1)); %green
% color2 = fun([150 150 150],tint_factor(2)); %gray
%color2 = fun([80 130 180],tint_factor(1)); %steel blue
%color2 = fun([70 130 180],tint_factor(2)); %steel blue+50% tint5
%color2 = fun([0 255 0],tint_factor(2)); % green
color2 = fun([255 0 255],tint_factor(2)); %magenta
%color2= fun([0 0 255],tint_factor(2)); %blue 
...
for fi = 1:numel(experiment)
    ...
    curr_file_data= curr_file_FI_data.aDAT;   %add this variable cause the data structure can change
...
text(18500, -5, '1 s', 'HorizontalAlignment', 'center')
