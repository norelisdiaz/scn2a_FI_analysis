...
%     
%     for i= 1:
    %Set up legend with the name of the filename so you can identify which
    %cell and current step
    
%     legendTitle = cell(1,N);
%     for i = 1:N
%     %Your other operations
%     [~,fileName,~] = fileparts(data);  % e.g., file is 'dp600_2_layers_L50.xlsx'
